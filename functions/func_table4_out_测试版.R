...
##########################################################################
#FDM
fdm = fitfdm(coulist = coulist, fore = TRUE, year = c(ystr,yetr,yste,yete),age = 5)
#STAR stack first,model1,2
VAR_1 = fitstar_rev(datar = datatr,'stack',fore = TRUE,datate = datate)
VAR_2 = fitstar_rev_sep(datar = datatr,'sep',fore = TRUE,datate = datate)
VAR_1$rmsfe
VAR_2$rmsfe
##########################################################################
#fit model1
...
f6 = fitswvar(datar = datatr, spaw = 1,datate = datate)
...
c(f0$RMSFE,fdm$summary$rmsfe,VAR_1$rmsfe,VAR_2$rmsfe,f3$rmsfe,f4$rmsfe,f5$rmsfe,f6$rmsfe)
c(f0$mae,fdm$summary$mae,VAR_1$mae,VAR_2$mae,f3$mae,f4$mae,f5$mae,f6$mae)

c(f0$RMSFE,fdm$summary$rmsfe,VAR_1$rmsfe,VAR_2$rmsfe)
c(f0$mae,fdm$summary$mae,VAR_1$mae,VAR_2$mae)
